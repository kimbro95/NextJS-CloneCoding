...
const Profile: NextPage = () => {
    return (
        <div className="py-10 px-4">
            ...
            <div className="mt-10 flex justify-around border-b pb-4">
                <div className="flex flex-col items-center">
                    ...
                    <span className="mt-2 text-sm font-bold text-gray-600">판매내역</span>
                </div>
                <div className="flex flex-col items-center">
                    <div className="w-14 h-14 bg-orange-500 rounded-full text-white flex items-center justify-center">
                        <svg
                            className="w-6 h-6"
                            fill="none"
                            stroke="currentColor"
                    ...
                    <span className="mt-2 text-sm font-bold text-gray-600">구매내역</span>
                </div>
                <div className="flex flex-col items-center">
                    <div className="w-14 h-14 bg-orange-500 rounded-full text-white flex items-center justify-center">
                        <svg
