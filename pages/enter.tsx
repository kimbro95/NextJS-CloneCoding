...
export default function Enter() {
    ...
    const onTokenVaild = (valiForm: TokenForm) => {
    ...
    return (
        <div className="mt-16 px-4">
            ...
            <div className="mt-8">
                {data?.ok ?
                    <form onSubmit={tokenHandleSubmit(onTokenVaild)} className="flex flex-col mt-4 space-y-4">
                        <Input
                    ...
                    <>
                        <div className="flex flex-col items-center">
                            ...
                            <div className="grid grid-cols-2 gap-16 border-b w-full mt-8 pb-4">
                                <button
                                    className={cls(
                ...
                <div className="grid grid-cols-2 gap-3 mt-2">
                    <button
                        className="flex justify-center items-center py-2 px-2 border border-gray-400 
                    rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-100"
                    >
                        <svg
                            className="w-5 h-5"
                            aria-hidden="true"
