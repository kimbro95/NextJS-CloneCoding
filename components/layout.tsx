    ...
    return (
        <div>
            <div className={cls(
                ...
                "flex items-center w-full max-w-lg font-bold py-3 fixed border-b top-0 bg-white text-lg text-gray800 px-8")}
            >
                {canGoBack ?
            ...
            {hasTabBar ? (
                <nav className="bg-white max-w-lg text-gray-700 border-t fixed bottom-0 w-full
                px-10 pb-15 pt-3  flex justify-between"
                >
                    <Link href="/">
                    ...
                    <Link href="/community">
                        <a className="flex flex-col items-center space-y-1">
                            ...
                            >
                                ...
                                2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7
                                16h6M7 8h6v4H7V8z"
                                />
                            </svg>
                            <span>동네생활</span>
